        ...
        <div className="max-w-7xl mx-auto px-12 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
          ...
          >
            <div className="inline-flex items-center space-x-2 px-3 py-1 bg-blue-500/10 border border-blue-500/20 rounded-full w-fit">
              ...
              <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-blue-400">Next-Gen Electronics Ready</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-slate-400 max-w-md leading-relaxed font-light">
              Sutric pioneers the infrastructure of the future with high-precision smart meters, IoT frameworks, and advanced power management.
            </p>
          ...
          >
             ...
             <div className="grid grid-cols-2 gap-6 w-full max-w-md relative z-20">
                {[
                  { icon: Zap, color: 'blue', title: 'Power Grid', desc: 'Efficiency increased by 32% with adaptive AI.' },
                  { icon: Radio, color: 'cyan', title: 'IoT Systems', desc: 'Seamless mesh networking for automation.' },
                  { icon: ShieldCheck, color: 'indigo', title: 'Certified QA', desc: 'Military-grade testing for critical hardware.' },
                  { icon: Globe, color: 'emerald', title: 'Energy Mgmt', desc: 'Real-time consumption analytics.' }
                ].map((item, idx) => (
                  <div 
                    key={idx} 
                    className={cn(
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-20 items-start">
            <div className="lg:col-span-1 border-l border-blue-500/30 pl-8 py-4">
              ...
              <p className="text-slate-400 mb-10 leading-relaxed font-light">
                Founded with a vision to redefine electronics engineering, Sutric combines deep manufacturing roots with modern AI-driven solutions to solve the most complex hardware challenges.
              </p>
            ...
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                { icon: Zap, title: 'Energy Efficiency', desc: 'Low-power circuit design that maximizes lifespan and reduces environmental impact.' },
                { icon: Globe, title: 'Global Connectivity', desc: 'Secure IoT frameworks designed for seamless cross-border integration.' },
                { icon: Users, title: 'Expert Support', desc: 'Dedicated engineering team available 24/7 for technical maintenance.' }
              ].map((feature, idx) => (
      ...
      <section className="py-32 px-12">
        <div className="max-w-6xl mx-auto bg-gradient-to-br from-blue-600 to-blue-800 rounded-[3rem] p-16 md:p-24 text-center text-white relative overflow-hidden shadow-[0_0_80px_rgba(37,99,235,0.2)]">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-10">
            <h2 className="text-5xl md:text-6xl font-light tracking-tight leading-tight">Ready to transform your tech <span className="font-bold">infrastructure?</span></h2>
